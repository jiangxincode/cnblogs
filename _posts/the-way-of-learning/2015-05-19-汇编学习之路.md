...
* MASM(Microsoft Macro Assembler): <https://zh.wikipedia.org/wiki/MASM>
* ml64.exe(Microsoft x64 Assembler): <https://learn.microsoft.com/en-us/cpp/assembler/masm/masm-for-x64-ml64-exe>
* ~~TASM(Turbo Assembler): <https://en.wikipedia.org/wiki/Turbo_Assembler>~~
* flat assembler: <http://www.flatassembler.net/>
* Yasm(complete rewrite of the NASM assembler): <https://github.com/yasm/yasm>
* NASM(Netwide Assembler): <http://www.nasm.us/>
* GoAsm/GoRC/GoLink/GoBug(The Go tools for Windows + Assembler): <https://www.godevtool.com/#assembler>
* as/ld(GNU Binutils): <https://www.gnu.org/software/binutils/>
