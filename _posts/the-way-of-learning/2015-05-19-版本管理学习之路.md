...
* git merge 的三种常用模式简介: <https://blog.csdn.net/vb748/article/details/125313366>
* git merge driver简介: <https://www.cnblogs.com/flyingicedragon/p/19116687>
...
* 开启 diff3，帮助解决 Git 合并冲突难题: <https://francecil.github.io/pages/17b23b/>
* Git merge diff3 style need explanation: <https://stackoverflow.com/questions/16990657/git-merge-diff3-style-need-explanation>
* Git Large File Storage (LFS): <https://git-lfs.com/>
* Encountered 1 file(s) that should have been pointers, but weren't: <https://github.com/git-lfs/git-lfs/issues/1939>
* detached HEAD state: <https://www.cnblogs.com/hustdc/p/6444910.html>

### Git常用命令

```shell
# 有时会碰到有一些中文文件名或者路径被转义成\xx\xx\xx，
# 这种转义虽然有利于系统兼容性，但是带来了阅读的麻烦
# 此时可以通过git的配置来改变默认转义；
git config --global core.quotepath false

git config --global user.email "jiangxinnju@163.com"
git config --global user.name "Aloys"
...
* chezmoi(Manage your dotfiles across multiple diverse machines, securely): <https://github.com/twpayne/chezmoi>
