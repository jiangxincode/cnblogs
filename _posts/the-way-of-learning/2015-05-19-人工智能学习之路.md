...
* Hindsight(Hindsight: Agent Memory That Learns): <https://github.com/vectorize-io/hindsight>
* GBrain(Garry's Opinionated OpenClaw/Hermes Agent Brain): <https://github.com/garrytan/gbrain>

## MCP(Model Context Protocol，模型上下文协议)

* Model Context Protocol: <https://modelcontextprotocol.io/specification/2025-11-25/basic/transports>
...
* mcp-remote(Connect an MCP Client that only supports local servers to a Remote MCP Server): <https://github.com/geelen/mcp-remote>
* next-ai-draw-io: <https://github.com/DayuanJiang/next-ai-draw-io>
* drawio-mcp(The official draw.io MCP server): <https://github.com/jgraph/drawio-mcp>
...
* Claude Code橙皮书: <https://my.feishu.cn/wiki/JK1WwrRgJiYfRok7YxxceS5qn1J>
...
* OpenSpec(About Spec-driven development for AI coding assistants): <https://github.com/Fission-AI/OpenSpec>
...
* Hyperframes(文本生成视频): <https://github.com/heygen-com/hyperframes>
...
* agency-agents-zh(即插即用的 AI 专家角色): <https://github.com/jnMetaCode/agency-agents-zh>
* html-anything: <https://github.com/nexu-io/html-anythin>
...
* cc-connector(Bridge local AI coding agents to messaging platforms): <https://github.com/chenhg5/cc-connect>
...
* Open Lovable(Clone and Recreate Any Website as a Modern React App in Seconds): <https://openlovable.com/>
