...
* hibp(Have I been pawned): <https://github.com/oschonrock/hibp>
* Pwned Passwords: <https://haveibeenpwned.com/Passwords>
* theHarvester(信息收集): <https://github.com/laramies/theHarvester>
* Holehe(邮箱注册网站检测): <https://github.com/megadose/holehe>
* socialscan(用户名和电子邮件注册网站检测): <https://github.com/iojw/socialscan>
* reg007(邮箱/手机注册网站检测): <https://www.reg007.com/>
* sherlock(社交媒体账号检测): <https://github.com/sherlock-project/sherlock>
* Maigret(Sherlock 的增强版，支持 2500+ 网站): <https://github.com/soxoj/maigret>
* Ignorant(手机注册网站检测): <https://github.com/megadose/ignorant>
* Mosint(自动化电子邮件安全情报工具): <https://github.com/alpkeskin/mosint>
* h8mail(电子邮件 OSINT 和入侵搜寻工具): <https://github.com/khast3x/h8mail>
* sn0int(信息收集和 OSINT 框架): <https://github.com/kpcyrd/sn0int>
