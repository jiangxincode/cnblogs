...
* C/C++ Compiler and build tools errors and warnings: <https://learn.microsoft.com/zh-cn/cpp/error-messages/compiler-errors-1/c-cpp-build-errors>
  ...
  * LNK2026(链接器工具错误): <https://learn.microsoft.com/zh-cn/previous-versions/visualstudio/visual-studio-2008/100ezk17(v=vs.90)>
...
* 从 WRL 移动到 C++/WinRT: <https://learn.microsoft.com/zh-cn/windows/uwp/cpp-and-winrt-apis/move-to-winrt-from-wrl>
* windows-data-types: <https://learn.microsoft.com/zh-cn/windows/win32/winprog/windows-data-types>
* OneCore.lib umbrella library (by module): <https://learn.microsoft.com/zh-cn/windows/win32/apiindex/umbrella-lib-onecore>
* Windows 8.1 API Sets: <https://learn.microsoft.com/zh-cn/windows/win32/apiindex/windows-81-api-sets>
* SecureZeroMemory function: <https://learn.microsoft.com/zh-cn/previous-versions/windows/desktop/legacy/aa366877(v=vs.85)>
* ShellExecuteA function: <https://learn.microsoft.com/zh-cn/windows/win32/api/shellapi/nf-shellapi-shellexecutea>
* CREATEGUID Function (GUID): <https://learn.microsoft.com/zh-cn/previous-versions/dynamicsnav-2013r2/dd339033(v=nav.71)>
...
* GetPrivateProfileString/WritePrivateProfileString(INI读取和写入): <https://learn.microsoft.com/zh-cn/windows/desktop/api/winbase/>
...
* Windows.Devices.WiFi Namespace: <https://learn.microsoft.com/zh-cn/uwp/api/windows.devices.wifi>
* Windows.Devices.WiFiDirect Namespace(含Wi-Fi Direct sample): <https://learn.microsoft.com/zh-cn/uwp/api/Windows.Devices.WiFiDirect><https://github.com/microsoft/Windows-universal-samples/tree/master/Samples/WiFiDirect>
* Windows.Devices.WiFiDirect.Services Namespace: <https://learn.microsoft.com/zh-cn/uwp/api/Windows.Devices.WiFiDirect.Services><https://github.com/microsoft/Windows-universal-samples/tree/master/Samples/WiFiDirectServices>
