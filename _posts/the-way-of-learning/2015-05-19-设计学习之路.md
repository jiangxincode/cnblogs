...
* C4D材质宝典（中文字幕）: <https://www.bilibili.com/video/BV1tJ411e7E3>
...
* Houdini(三维动画和视觉特效软件): <https://www.sidefx.com/products/houdini/>
* ~~zmaker(电子杂志制作): <http://zmaker.zcom.com/>~~
* ~~iebook(电子杂志制作): <http://www.iebook.cn/>~~

## 一些培训和教程

* 动效设计中的物理模拟: <https://www.shejidaren.com/motion-design-with-physics.html>

* 火星时代教育: <https://study.hxsd.com/>
* 直线网: <https://www.linecg.com/>
* 时间轴: <https://timelinefx.com/>
