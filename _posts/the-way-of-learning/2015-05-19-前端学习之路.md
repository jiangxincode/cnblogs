...
* Turborepo(高性能构建系统): <https://turborepo.dev/>
...
* Vue I18n(Vue I18n is internationalization plugin for Vue.js): <https://kazupon.github.io/vue-i18n/>
...
* Jest(Jest基于Jasmine): <https://jestjs.io/>
* Jasmine: <https://github.com/jasmine/jasmine>
* ~~jsunit: <http://github.com/pivotal/jsunit>~~

## CSS

* Tailwind CSS(提供大量的工具类): <https://tailwindcss.com/>
* PostCSS(一个用 JavaScript 编写的工具，用于转换 CSS 代码): <https://postcss.org/>

## 其它

* uiverse(The Largest Library of Open-Source UI): <https://uiverse.io/>
...
* expo(making universal native apps with React): <https://github.com/expo/expo>
