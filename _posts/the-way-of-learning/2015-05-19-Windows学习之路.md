...
* WSL通过fastboot连接手机：<https://learn.microsoft.com/zh-cn/windows/wsl/connect-usb>
* "NAT 模式下的 WSL 不支持 localhost 代理"告警处理: <https://zhuanlan.zhihu.com/p/15762609815>
...
* What's the difference between command.com and cmd.exe? <https://superuser.com/questions/276061/whats-the-difference-between-command-com-and-cmd-exe>
...
* win8内置管理员账号既能使用metro应用又能使用默认共享: <https://www.cnblogs.com/dcrenl/p/4033646.html>
...
* Windows 中的硬链接、目录联接(软链接)、符号链接、快捷方式: <https://www.cnblogs.com/czwy/p/18442267>
