...
* 漏学Input知识系列之“偷”走了其他窗口的事件pilferPointers: <https://mp.weixin.qq.com/s/l_mQK1xs8d4dp7VMkl0kyw>
...
* Handler sync barrier（同步屏障）: <https://blog.csdn.net/jdsjlzx/article/details/110563162>
...
* atrace(android)/ptrace(linux): <https://juejin.cn/post/7053395801510248455>
...
* Androidify on Android(Use AI to create your own Android bot with Androidify): <https://github.com/android/androidify>
