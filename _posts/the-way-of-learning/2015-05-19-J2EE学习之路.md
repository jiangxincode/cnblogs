...
* java-vs-javaw-vs-javaws: <https://javapapers.com/core-java/java-vs-javaw-vs-javaws/>
...
* spring-framework Doc：<https://docs.spring.io/spring-framework/reference/>
...
* Access denied to: http://repo.spring.io: <https://stackoverflow.com/questions/22099519/cannot-access-repo-spring-io-for-spring-boot-exercises>
...
* Micrometer Observation: <https://docs.spring.io/spring-framework/reference/integration/observability.html#observability.concepts>
* Prometheus：<https://prometheus.io/>
* EXPOSITION FORMATS: <https://prometheus.io/docs/instrumenting/exposition_formats/>
* Prometheus 系统监控方案: <http://www.cnblogs.com/vovlie/p/Prometheus_CONCEPTS.html>
* grafanagrafana: <https://grafana.com/>
