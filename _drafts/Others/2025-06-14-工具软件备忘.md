...
|[Mermaid](https://mermaid.js.org/)|是|Web|开源免费| |
...
* Yandex(俄罗斯的搜索引擎): <https://yandex.com/>
* Wolfram|Alpha(计算知识引擎): <https://www.wolframalpha.com/>
...
* 离线盒子: <https://www.lixianhezi.com/>
* ~~Ubunut One: <https://one.ubuntu.com/>~~

* 夸克网盘资源: <https://www.kdocs.cn/l/csV4wXELXmRL>
* 115网盘资源: <https://docs.qq.com/sheet/DTU5jRklaWUJtTEZX?tab=000001>
* 115网盘资源整理: <https://docs.qq.com/sheet/DTU5vZWdVZ0JnT2dk?tab=BB08J2>
* 猪猪盘百度网盘资源搜索: <http://www.zhuzhupan2.com/>
...
* Ventoy(制作可启动U盘的开源工具): <https://www.ventoy.net/cn/index.html>
* Rufus(轻松创建USB启动盘): <https://rufus.ie/>
* balenaEtcher(Flash OS images to SD cards & USB drives): <https://etcher.balena.io/>
* UNetbootin: <https://unetbootin.github.io/>
* Universal USB Installer(creating USB boot drives from ISO files): <https://pendrivelinux.com/universal-usb-installer-easy-as-1-2-3/>
* ~~LinuxLive USB Creator(已停止维护): <https://linuxliveusb.com/>~~
* 微PE工具箱: <https://www.wepe.com.cn/>
* ~~大白菜(有大量捆绑): <https://www.dabaicai.com/>~~
* 老毛桃: <https://www.laomaotao.net/>
* EasyBCD(Dual-boot with any operating system): <https://easybcd.org/>
* 图拉丁吧工具箱(图吧工具箱)：<https://www.tbtool.cn/>
...
* Alignment Tool Professional(无损4k分区对齐): <https://www.paragon-software.com/home/partition-alignment/>
* DiskGenius: <https://www.diskgenius.cn/>
* gparted: <https://gparted.org/>
* SpaceSniffer: <http://www.uderzo.it/main_products/space_sniffer/>
* windirstat: <https://github.com/windirstat/windirstat>
* Process Explorer(procexp, 查看进程占用文件): <https://learn.microsoft.com/en-us/sysinternals/downloads/process-explorer>
...
* Registry Workshop: <https://www.torchsoft.com/en/rw_information.html>

* CCleaner: <https://www.ccleaner.com/ccleaner>
* Total Uninstall: <https://www.martau.com/zh-CN/>
...
* ~~金山重装高手：<https://www.ijinshan.com/zt/ws_dnxtczbz.shtml>~~
...
* Clash重要链接: <https://github.com/clash-download/Clash>
...
* SecureCRT/SecureFX(收费): <https://www.vandyke.com/products/index.html>
...
* ncmdump(Convert Netease Cloud Music ncm files to mp3/flac files): <https://github.com/taurusxin/ncmdump>
...
* Teleport: <https://www.tenmax.com/teleport/pro/home.htm>

## 企业相关

* WorkWin管理专家(全方位监控，杜绝员工玩电脑游戏、网购、拷贝机密文件、泄密、飞单): <https://www.vipshare.com/>
...
* ~~财智: <http://o.imoney.com.cn/Index.aspx>~~
* ~~365日历: <https://www.365rili.com/>~~
* Taskwarrior: <https://taskwarrior.org/>

## 驱动

* GeForce Game Ready Driver(英伟达驱动): <https://www.nvidia.com/download/driverResults.aspx/235904/en-us/www.linkedin.com>
...
* Playwright(One API to drive Chromium, Firefox, and WebKit): <https://playwright.dev/>
...
* TicKeys(打字音效): <https://www.yingdev.com/projects/tickeys>
...
* Open Live Writer(An open source fork of Windows Live Writer): <https://github.com/OpenLiveWriter/OpenLiveWriter>
